...
<div class="topbar d-flex justify-content-between align-items-center">
    ...
    <li class="nav-item dropdown list-unstyled m-0">
            <a id="staffNotificationDropdown" class="nav-link position-relative" href="#" role="button" data-bs-toggle="dropdown">
        <i class="bi bi-bell" style="font-size: 1.5rem;"></i>
        <span id="staffNotificationBadge" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger d-none">
            0
        </span>
    </a>
        ...
        <li class="text-center border-top p-2">
            <button id="markAllStaffRead" class="btn btn-sm btn-outline-primary rounded-pill">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Pusher listener untuk notifikasi real-time
    ...
    var channel = pusher.subscribe('private-staff-notifications.{{ auth()->id() }}');
    channel.bind('new-staff-notification', function(data) {
        badge.classList.remove('d-none');
    ...
    document.getElementById('markAllStaffRead').addEventListener('click', function(e) {
        e.preventDefault();
