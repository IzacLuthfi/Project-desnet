...
@section('content')
  <div class="card-box mb-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
      ...
      <input type="text" class="form-control w-auto" placeholder="Cari Nama Pengguna..." style="width: 250px;">
    </div>
    ...
    .then(async res => {
      if (res.ok) {
        ...
        newRow.innerHTML = `
          ...
          <td class="text-center">
            <a href="#" class="btn btn-warning btn-sm rounded-2 me-1">
              <i class="bi bi-pencil-square"></i> Edit
            </a>
        ...
        let errors = Object.values(err.errors).flat().join('<br>');
...
formEditUser.addEventListener('submit', function(e) {
  ...
  fetch(`/admin/kelola-user/${id}`, {
    method: 'POST', // Laravel butuh POST + _method
  ...
  // Handle hapus pakai SweetAlert2
  document.addEventListener('click', function (e) {
